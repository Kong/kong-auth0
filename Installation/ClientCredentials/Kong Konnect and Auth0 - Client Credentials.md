# Kong Konnect and Auth0 - Client Credentials Grant
...
Please, refer to the following link to learn more about OAuth/OIDC and its [Flows](https://auth0.com/docs/authenticate/protocols/openid-connect-protocol)
